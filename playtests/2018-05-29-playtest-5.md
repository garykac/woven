...
Matrix. Any cubes that are covered by the new card
are removed from the Matrix and added back into
your pool.

### Casting Spells

Take the specified number of cubes from your pool and add them one at
a time to the Matrix.

After each cube is placed, if that cube completes a
