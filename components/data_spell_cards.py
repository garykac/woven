...
spell_card_data = [
    ...
    ["Haste",
        {'element': 'air', 'pattern': 'E2-5', 'op': 'eye', 'vp': 0,
    ...
    ["Gust",
        {'element': 'air', 'pattern': 'E1-3', 'op': 'move', 'vp': 0,
    ...
    ["Endurance",
        {'element': 'earth', 'pattern': 'E2-16', 'op': 'tapestry-eye', 'vp': 0,
    ...
    ["Stone Hand",
        {'element': 'earth', 'pattern': 'E2-6', 'op': 'eye-thread', 'vp': 0,
    ...
    ["Bolt",
        {'element': 'fire', 'pattern': 'E2-79', 'op': 'move', 'vp': 0,
    ...
    ["Fire Shards",
        {'element': 'fire', 'pattern': 'E2-27', 'op': 'thread', 'vp': 0,
    ...
    ["Bridge",
        {'element': 'water', 'pattern': 'E1-2', 'op': 'thread', 'vp': 0,
    ...
    ["Spread",
        {'element': 'water', 'pattern': 'E2-28', 'op': 'eye', 'vp': 0,
    ...
    ["Blur",
        {'element': 'air', 'pattern': 'E2-51', 'op': 'eye', 'vp': 1,
    ...
    ["Duplicate",
        {'element': 'water', 'pattern': 'E2-35', 'op': 'move-eye', 'vp': 1,
    ...
    ["Traceback",
        {'element': 'water', 'pattern': 'E2-32', 'op': 'move-eye', 'vp': 1,
    ...
    ["Expand",
        {'element': 'water', 'pattern': 'E2-27', 'op': 'move', 'vp': 1,
    ...
    ["Burst",
        {'element': 'water', 'pattern': 'E2-47', 'op': 'move', 'vp': 1,
    ...
    ["Anchor",
        {'element': 'earth', 'pattern': 'E2-14', 'op': 'thread', 'vp': 1,
    ...
    ["Fiery Fire Flame",
        {'element': 'fire', 'pattern': 'E2-35', 'op': 'eye', 'vp': 1,
    ...
    ["Redirect",
        {'element': 'fire', 'pattern': 'E2-106', 'op': 'tapestry-eye', 'vp': 1,
         'id': 101, 'category': 'mage-other-attack'},
        {
            'cast': "Attack 1 at one of your Eyes.",
            'react': "When attacked, redirect the attack to one of your Eyes.",
    ...
    ["Shield",
        {'element': 'earth', 'pattern': 'E2-15', 'op': 'move-eye', 'vp': 1,
    ...
    ["Deflect",
        {'element': 'earth', 'pattern': 'E2-7', 'op': 'move-eye', 'vp': 1,
         'id': 100, 'category': 'mage-defend'},
        {
            'cast': "Deflect an attack of 1",
            'react': "May also be cast in response to an attack.",
        } ],
